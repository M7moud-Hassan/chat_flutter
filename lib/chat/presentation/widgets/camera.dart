...
// New path with .mp4 extension
    final newPath = tempPath.replaceAll('.temp', '.mp4');

// Move/rename the file
    final newFile = await File(tempPath).rename(newPath);
    timer.cancel();
    ...
    final result = ref
        .read(chatControllerProvider.notifier)
        .createAttachmentsFromFiles([File(newFile.path)]);
